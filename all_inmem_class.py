...
class PowerGrid(InMemoryDataset):
    ...
    def processed_file_names(self):
        return f'data_{self.datatype.lower()}.pt'
...
dataset = PowerGrid(root = 'uk+expmask', name= 'uk', datatype='binary')

# dataset = torch.load("uk+expmask/processed/data.pt")

# print("dataset: ",dataset, flush = True)
# print("0th element: ", dataset[0], flush = True)
# print("0th element x: ",dataset[0].x, flush = True)

# print("dataset.data: ",dataset.data, flush = True)

# dataset.data.x = dataset.data.x.float()
# print(f"dataset.data.x: {dataset.data.x}", flush = True)
# dataset.data.y = dataset.data.y.squeeze().long()
# print(f"dataset.data.y: {dataset.data.y}", flush = True)